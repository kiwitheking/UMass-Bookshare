...
exports.getPassword = function getPassword_(username_, res_, req_) {
    user_i.getPassword(username_, res_, req_);
}
...
*/
exports.makeListing = function makeListing_(username_, isbn13_, forRent, forSale, forBorrow, function_) {
    list_i.makeListing(username_, isbn13_, forRent, forSale, forBorrow, function_);
}
