...
exports.getPassword = function getPassword(username_, res_, req_) {
    ...
    found.then(function(record){
        ...
        if(record != null) {
            console.log(record);
           /* bcrypt.compare(req.body.password, record, function(err, matches){
              if(err){
                console.log("Error!");
                res.redirect('/');
              } else if(matches) {
                console.log("The password is valid!");
                db.loginUser(req.body.username, hashPass, res, req);
              } else {
   ...
   //console.log(SELECT password FROM users WHERE username= + username_);
}
/**
...
/*            if (pass_ === record.dataValues.password.trim()) {
              ...
              res_.render('/', { message: 'Invalid email or password.' });
            }*/
          }
    })
}
