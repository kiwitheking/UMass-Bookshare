...
function requestUserData(username_)
{
	...
	DB_Interface.searchBook(search, res.render('/home, '))
}
function test(record){
	res.render('/home', record.username);
}
...
//DB_Interface.search("a", log2_);

DB_Interface.addBookWish("cute", "9780449213940", null, null) 
 //DB_Interface.rateUser('bianca', 'walter', 1, log_);
 //DB_Interface.getRating('bianca', 'walter', log_);

//DB_Interface.makeListing("pcalderw1", "9785555555555", true, true, true, log_);
